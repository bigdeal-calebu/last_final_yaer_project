...
def show_register_student_content(content_area, responsive_manager):
    ...
    ctk.CTkLabel(header_frame, text="Register New Student", text_color="#2ECC71", font=("Segoe UI", 28, "bold")).pack(anchor="w")
    ctk.CTkLabel(header_frame, text="Add a new student profile to the facial recognition system.", text_color="gray", font=("Segoe UI", 12)).pack(anchor="w")
    ...
    btn_reg.pack(fill="x", pady=(10, 30))
